...
const HeroSection = () => {
  return (
    <section className="flex flex-col text-center pt-32 md:pt-36 pb-0 relative overflow-visible">
...
{/* Left corner background image */}
      ...
      <div className="container mx-auto px-4">
        <motion.div
          ...
          className="mb-0 pb-0 relative z-10"
        >
          ...
          <p className="text-lg md:text-xl text-white/70 mb-16 max-w-4xl mx-auto">
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: -120 }} // y:0 para que la animación no la mueva, el translate se encarga
          transition={{ duration: 0.6, delay: 0.3 }}
          className="relative mx-auto w-full overflow-hidden pt-0 z-10 transform -translate-y-[30px] -mb-[30px] md:-translate-y-[120px] md:-mb-[120px]"
        >
          {/* Dashboard Image */}
